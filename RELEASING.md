...
ccnotifs uses semantic versioning.
...
- `install.sh` installs the latest GitHub release by default.
- Set `CCNOTIFS_REF=vX.Y.Z` to pin a specific release.
- Set `CCNOTIFS_REF=main` to install the unreleased branch head.
